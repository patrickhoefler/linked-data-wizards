...
ROOT_URLCONF = 'ldva.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ldva.wsgi.application'
...
INSTALLED_APPS = (
    ...
    'ldva.libs.social_auth',
    'ldva.libs.sparql',
    'ldva.libs.cubifier',
    # CODE applications
    'ldva.apps.platform',
    'ldva.apps.querywizard',
    'ldva.apps.visbuilder',
)

AUTHENTICATION_BACKENDS = (
    #'social.backends.mendeley.MendeleyOAuth2',
    'ldva.libs.social_auth.backends.contrib.mendeley.MendeleyOAuth2',
